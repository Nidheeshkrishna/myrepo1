...
//
//     final square = squareFromMap(jsonString);
...
class Square {
  ...
  factory Square.fromMap(Map<String, dynamic> json) => Square(
        square: json["square"] == null
            ? null
            : List<SquareElement>.from(
                json["square"].map((x) => SquareElement.fromMap(x))),
      );

  Map<String, dynamic> toMap() => {
        "square": square == null
            ? null
            : List<dynamic>.from(square.map((x) => x.toMap())),
      };
}
...
class SquareElement {
  ...
  factory SquareElement.fromJson(String str) =>
      SquareElement.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SquareElement.fromMap(Map<String, dynamic> json) => SquareElement(
...
class Permissions {
  ...
  factory Permissions.fromMap(Map<String, dynamic> json) => Permissions(
        ...
        maintain: json["maintain"] == null ? null : json["maintain"],
        push: json["push"] == null ? null : json["push"],
        triage: json["triage"] == null ? null : json["triage"],
        pull: json["pull"] == null ? null : json["pull"],
      );

  Map<String, dynamic> toMap() => {
        "admin": admin == null ? null : admin,
        "maintain": maintain == null ? null : maintain,
        "push": push == null ? null : push,
        "triage": triage == null ? null : triage,
